...
public class Defs {
    ...
    static final int SPR_DUNG = 33;
    static final int SPR_ERROR = 34;
    ...
    static final int SPR_OVERHEAD_SIGN_BASE_TOP = 49;
    static final int SPR_PASSAGEWAY_LEFT = 50;
    static final int SPR_PASSAGEWAY_LEFT_FG = 51;
    static final int SPR_PASSAGEWAY_MIDDLE = 52;
    static final int SPR_PASSAGEWAY_RIGHT = 53;
    static final int SPR_PASSAGEWAY_RIGHT_FG = 54;
    static final int SPR_PASSAGEWAY_RIGHT_CLOSED = 55;
    static final int SPR_PAUSE = 56;
    static final int SPR_PLAYER_STAND = 57;
    static final int SPR_PLAYER_WALK = 58;
    static final int SPR_PLAYER_JUMP = 59;
    static final int SPR_PLAYER_GRABROPE = 60;
    static final int SPR_PLAYER_THROWBACK = 61;
    static final int SPR_PLAYER_SLIP = 62;
    static final int SPR_PLAYER_RUN = 63;
    static final int SPR_PLAYER_CLEAN_DUNG = 64;
    static final int SPR_POLE = 65;
    static final int SPR_PUSH_ARROW = 66;
    static final int SPR_ROPE_HORIZONTAL = 67;
    static final int SPR_ROPE_VERTICAL = 68;
    static final int SPR_SPRING = 69;
    static final int SPR_TOUCH_LEFT = 70;
    static final int SPR_TOUCH_LEFT_HELD = 71;
    static final int SPR_TOUCH_RIGHT = 72;
    static final int SPR_TOUCH_RIGHT_HELD = 73;
    static final int SPR_TOUCH_JUMP = 74;
    static final int SPR_TOUCH_JUMP_HELD = 75;
    static final int SPR_TRUCK = 76;
    static final int SPR_DIALOG_PLAY = 77;
    static final int SPR_DIALOG_PLAY_SELECTED = 78;
    static final int SPR_DIALOG_JUKEBOX = 79;
    static final int SPR_DIALOG_JUKEBOX_SELECTED = 80;
    static final int SPR_DIALOG_OPTIONS = 81;
    static final int SPR_DIALOG_OPTIONS_SELECTED = 82;
    static final int SPR_DIALOG_ABOUT = 83;
    static final int SPR_DIALOG_ABOUT_SELECTED = 84;
    static final int SPR_DIALOG_QUIT = 85;
    static final int SPR_DIALOG_QUIT_SELECTED = 86;
    static final int SPR_DIALOG_RETURN = 87;
    static final int SPR_DIALOG_RETURN_SELECTED = 88;
    static final int SPR_DIALOG_CREDITS = 89;
    static final int SPR_DIALOG_CREDITS_SELECTED = 90;
    ...
    static final int SPR_DIALOG_NORMAL = 103;
    static final int SPR_DIALOG_NORMAL_SELECTED = 104;
    static final int SPR_DIALOG_HARD = 105;
    static final int SPR_DIALOG_HARD_SELECTED = 106;
    static final int SPR_DIALOG_HARD_DISABLED = 107;
    static final int SPR_DIALOG_SUPER = 108;
    static final int SPR_DIALOG_SUPER_SELECTED = 109;
    static final int SPR_DIALOG_SUPER_DISABLED = 110;
    static final int SPR_DIALOG_1 = 111;
    static final int SPR_DIALOG_1_SELECTED = 112;
    static final int SPR_DIALOG_2 = 113;
    static final int SPR_DIALOG_2_SELECTED = 114;
    static final int SPR_DIALOG_3 = 115;
    static final int SPR_DIALOG_3_SELECTED = 116;
    static final int SPR_DIALOG_4 = 117;
    static final int SPR_DIALOG_4_SELECTED = 118;
    static final int SPR_DIALOG_5 = 119;
    static final int SPR_DIALOG_5_SELECTED = 120;
    static final int SPR_DIALOG_LOCKED = 121;
    static final int SPR_DIALOG_BORDER_TOPLEFT = 122;
    static final int SPR_DIALOG_BORDER_TOPLEFT_SELECTED = 123;
    static final int SPR_DIALOG_BORDER_TOPLEFT_DISABLED = 124;
    static final int SPR_DIALOG_BORDER_TOP = 125;
    static final int SPR_DIALOG_BORDER_TOP_SELECTED = 126;
    static final int SPR_DIALOG_BORDER_TOP_DISABLED = 127;
    static final int SPR_DIALOG_BORDER_LEFT = 128;
    static final int SPR_DIALOG_BORDER_LEFT_SELECTED = 129;
    static final int SPR_DIALOG_BORDER_LEFT_DISABLED = 130;
